...
use CB\WarehouseBundle\Form\AccountType;
...
class AccountController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CBWarehouseBundle:Account')->findAll();
     ...
     * @Method("POST")
     * @Template("CBWarehouseBundle:Account:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CBWarehouseBundle:Account')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CBWarehouseBundle:Account:edit.html.twig")
     */
